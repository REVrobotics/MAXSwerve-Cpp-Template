...
MAXSwerveModule::MAXSwerveModule(const int drivingCANId,
                           const int turningCANId,
...
void MAXSwerveModule::SetDesiredState(const frc::SwerveModuleState& desiredState) {
    ...
    frc::SwerveModuleState optimizedDesiredState{frc::SwerveModuleState::Optimize(correctedDesiredState,
...
void MAXSwerveModule::ResetEncoders() {
  m_drivingEncoder.SetPosition(0);
}
